...
OWNER_ID = int(getenv("OWNER_ID", "7466216344"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Ankit21ri/SWEET_TOXIC_MUSIC_BOT",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/poision_support")
